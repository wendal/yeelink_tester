...
#
# Created: Mon Sep 22 09:25:53 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1160, 876)
        self.centralWidget = QtGui.QWidget(MainWindow)
        self.centralWidget.setObjectName(_fromUtf8("centralWidget"))
        self.groupBox = QtGui.QGroupBox(self.centralWidget)
        self.groupBox.setGeometry(QtCore.QRect(870, 10, 281, 391))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(870, 410, 281, 251))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(10, 10, 851, 391))
        self.groupBox_3.setAutoFillBackground(True)
        self.groupBox_3.setObjectName(_fromUtf8("groupBox_3"))
        self.ui_text_uapikey = QtGui.QLineEdit(self.groupBox_3)
        self.ui_text_uapikey.setGeometry(QtCore.QRect(120, 90, 291, 21))
        ...
        self.ui_button_get_sensors.setGeometry(QtCore.QRect(720, 140, 101, 31))
        ...
        self.ui_button_check_api.setGeometry(QtCore.QRect(720, 100, 101, 31))
        ...
        self.label_8.setGeometry(QtCore.QRect(20, 150, 81, 16))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.label_10 = QtGui.QLabel(self.groupBox_3)
        self.label_10.setGeometry(QtCore.QRect(20, 120, 72, 15))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.ui_table_sensors = QtGui.QTableWidget(self.groupBox_3)
        self.ui_table_sensors.setGeometry(QtCore.QRect(10, 180, 831, 201))
        ...
        self.ui_combo_devid.setGeometry(QtCore.QRect(120, 120, 291, 22))
        ...
        self.ui_txt_srv_type = QtGui.QComboBox(self.groupBox_3)
        self.ui_txt_srv_type.setGeometry(QtCore.QRect(120, 30, 141, 22))
        self.ui_txt_srv_type.setObjectName(_fromUtf8("ui_txt_srv_type"))
        self.ui_txt_srv_type.addItem(_fromUtf8(""))
        self.ui_txt_srv_type.addItem(_fromUtf8(""))
        self.label = QtGui.QLabel(self.groupBox_3)
        self.label.setGeometry(QtCore.QRect(20, 30, 91, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_9 = QtGui.QLabel(self.groupBox_3)
        self.label_9.setGeometry(QtCore.QRect(20, 60, 91, 16))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.ui_txt_srv_api_url = QtGui.QLineEdit(self.groupBox_3)
        self.ui_txt_srv_api_url.setGeometry(QtCore.QRect(120, 60, 461, 21))
        self.ui_txt_srv_api_url.setObjectName(_fromUtf8("ui_txt_srv_api_url"))
        self.label_11 = QtGui.QLabel(self.groupBox_3)
        self.label_11.setGeometry(QtCore.QRect(420, 90, 72, 15))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.ui_txt_username = QtGui.QLineEdit(self.groupBox_3)
        self.ui_txt_username.setGeometry(QtCore.QRect(480, 90, 201, 21))
        self.ui_txt_username.setObjectName(_fromUtf8("ui_txt_username"))
        self.groupBox_4 = QtGui.QGroupBox(self.centralWidget)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 410, 851, 451))
        ...
        self.ui_button_help.setGeometry(QtCore.QRect(950, 750, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "物联网 API调试工具 v1.1 by wendal.net", None))
        ...
        self.ui_txt_srv_type.setItemText(0, _translate("MainWindow", "yeelink", None))
        self.ui_txt_srv_type.setItemText(1, _translate("MainWindow", "uiot", None))
        self.label.setText(_translate("MainWindow", "服务器类型", None))
        self.label_9.setText(_translate("MainWindow", "服务器地址", None))
        self.ui_txt_srv_api_url.setText(_translate("MainWindow", "api.yeelink.net", None))
        self.label_11.setText(_translate("MainWindow", "用户名", None))
