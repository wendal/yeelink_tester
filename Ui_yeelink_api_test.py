...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ui_text_file_path.setGeometry(QtCore.QRect(130, 100, 541, 21))
        self.ui_text_file_path.setObjectName(_fromUtf8("ui_text_file_path"))
        self.ui_button_select_file = QtGui.QPushButton(Dialog)
        self.ui_button_select_file.setGeometry(QtCore.QRect(680, 100, 61, 28))
        ...
        self.ui_button_send_file.setGeometry(QtCore.QRect(670, 150, 93, 28))
        self.ui_button_send_file.setObjectName(_fromUtf8("ui_button_send_file"))
        self.ui_button_send_text = QtGui.QPushButton(Dialog)
        self.ui_button_send_text.setGeometry(QtCore.QRect(670, 200, 93, 28))
        ...
        self.ui_button_send_text_hex.setGeometry(QtCore.QRect(670, 250, 93, 28))
        self.ui_button_send_text_hex.setObjectName(_fromUtf8("ui_button_send_text_hex"))
        self.ui_button_send = QtGui.QPushButton(Dialog)
        self.ui_button_send.setGeometry(QtCore.QRect(670, 300, 93, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ui_button_send_file.setText(_translate("Dialog", "发送文件", None))
        self.ui_button_send_text.setText(_translate("Dialog", "发送文本", None))
        self.ui_button_send_text_hex.setText(_translate("Dialog", "发送文本hex", None))
